...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <x-adminlte-small-box title="16.765*" text="Productos Nunca Vendidos" icon="fas fa-shopping-bag" theme="warning" url="#" url-text="Mas Información"/>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <x-adminlte-small-box title="12.355*" text="Matcheados con Distribase" icon="fas fa-shopping-bag" theme="success" url="#" url-text="Mas Información"/>
        </div>
        
        <div class="col-md-3">
            {{-- NO Matcheados con Distribase --}}
            <x-adminlte-small-box title="10.325*" text="NO Matcheados con Distribase" icon="fas fa-shopping-bag" theme="success" url="#" url-text="Mas Información"/>
        </div>
        ...
        <div class="col-md-3">
            ...
            <x-adminlte-small-box title="5.890*" text="Productos con Neto en CSV" icon="fas fa-shopping-bag" theme="success" url="#" url-text="Mas Información"/>
        </div>
    </div>
